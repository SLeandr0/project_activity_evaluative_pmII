...
export repositorio="https://github.com/SLeandr0/project_activity_evaluative_pmII";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="trabalho-oficial-audition/falta-ver-o-microfone-$(date -I)"
